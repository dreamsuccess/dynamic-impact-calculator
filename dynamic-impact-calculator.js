...
function calculateText(donationAmount) {
    ...
    if (msistof) {
        return kids > 1 ? "Your <span style='text-decoration: underline; text-decoration-color:  rgb(21, 76, 154); text-decoration-thickness: 18%;'>$" + numberWithCommas(donationAmount) + "</span> monthly donation can give <span style='text-decoration: underline; text-decoration-color:  rgb(21, 76, 154); text-decoration-thickness: 18%;'>" + numberWithCommas(kids) + "</span> children education every year." : "Your <span style='text-decoration: underline; text-decoration-color:  rgb(21, 76, 154); text-decoration-thickness: 18%;'>$" + numberWithCommas(donationAmount) + "</span> monthly donation can give <span style='text-decoration: underline; text-decoration-color:  rgb(21, 76, 154); text-decoration-thickness: 18%;'>" + numberWithCommas(kids) + "</span> child education every year.";
    }
}
